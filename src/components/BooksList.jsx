        ...
        <div className='d-flex flex-wrap justify-content-center'>
            {arr.length>0 && arr.map(item=>
                <div key={item.id} className='item-book'>
                    <div className='d-flex justify-content-center'><img className='item-img' src={item.volumeInfo.imageLinks===undefined ?  '' : item.volumeInfo.imageLinks.thumbnail} alt="ava"/></div>
